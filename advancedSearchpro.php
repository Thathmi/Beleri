...
<div class="row">
    <div class="offset-0 offset-lg-1 col-12 col-lg-10 text-center">
        <div class="row ">
            ...
            $products1 = Database::search($quvry);
            $nProduct = $products1->num_rows;
            $userProduct = $products1->fetch_assoc();
                ...
                <div class="card mb-3 mt-3 col-12 col-lg-6">
                    <div class="row">
                        <div class="col-md-4 mt-4">
                            ...
                            $pimgrs = Database::search("SELECT * FROM `image` WHERE `product_id`= '" . $productImage["id"] . "'");
