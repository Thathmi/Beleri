...
// $a = Database::search("SELECT * FROM `product` WHERE  `category_id`='".$t."' ");
// $aa=$a->fetch_assoc();
// $aaa = $aa["model_has_brand_model_id"];

// $b = Database::search("SELECT * FROM `model_has_brand` WHERE  `id`='".$aaa."' ");
// $bb=$b->fetch_assoc();
// $bbb = $bb["brand_id"];

// $c = Database::search("SELECT * FROM `brand` WHERE  `id`='".$bbb."' ");
// $cc=$c->fetch_assoc();
// $ccc = $cc["name"];


$resulset = Database::search("SELECT * FROM `product` WHERE `title` LIKE '%".$i."%'  AND `category_id`='".$t."' ");
?>
