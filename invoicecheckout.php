        ...
        <div class="row">
            ...
            <div id="GFG">
               ...
               $in = $invoicers->num_rows;
                   ...
                   $irr = $invoicers->fetch_assoc();
                   ?>

                        <div class="col-5 col-md-4 offset-md-4 offset-0 text-end">
                            <h3 style="color: #769CC9;">INVOICE <?php echo $irr["id"]; ?></h3>
                            <span>Date and Time of Invoice:</span>&nbsp;<span> <?php echo $irr["date"]; ?></span>
                        </div>
                ...
                <div class="col-12 mt-3">
                    ...
                    ?>
                        <tr class="table table-light">
                            <td class=" text-white" style="background-color: #769CC9;"> <?php echo $i; ?></td>
...
<!-- 
                    ...
                    ?>
                      <tr>
                            ...
                            <td></td>
                            <td class="">SUBTOTAL</td>
                            <td class="table-light">Rs. <?php echo $t; ?></td>
                        </tr>
                        <tr>
                            <td colspan="2" class="border-0"></td>
                            <td class="border-primary"></td>
                        ...
                        <tr>
                            <td colspan="2" class="border-0 fs-5 fw-bolder">Thank You!</td>
                            <td colspan="2" class="border-0 text-primary text-end fs-6">GRAND TOTAL</td>
                            <td class="border-0 text-primary fs-6">Rs. <?php echo $t; ?></< /td>
                        </tr>
